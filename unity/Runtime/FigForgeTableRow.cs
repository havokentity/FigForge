// =============================================================================
// FigForge — a single Table row. Recolours its background graphic per
// interaction state (Regular / Rollover / Pressed / Selected) and reports clicks
// to the owning FigForgeTable so the table keeps a single-selected row — the
// FigForgeListRow pattern with a table owner.
// =============================================================================
...
namespace FigForge
{
    [AddComponentMenu("FigForge/Table Row")]
    public class FigForgeTableRow : MonoBehaviour,
        IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler
    {
        public FigForgeTable owner;
        public int index;
