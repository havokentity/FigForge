...
// screen it isn't registered with the UIFrameManager, so nothing snaps it to the
// viewport. At play-time this fills the parent canvas itself — the same effect
// UIFrameManager.FillParent gives screens — so its dialogs cover the whole screen
